...
<body>
	<form:form action="allProductsByUser" commandName="Product"
		...
		<center>
			<h2 style="color: black; margin-top: 10%;">Product Details</h2>
		</center>
		<div class="progress">
		...
		<c:forEach items="${product}" var="element" varStatus="status">
			<div class="container-fluid" style="margin-top: 2%">
				<div class="row" id="product">
					...
					<a style="color: white;"
						href="<c:url value='/addToCart/${product[status.index].productId}'/>"
						role="button" class="button"><i class="material-icons"
						style="margin-right: -1%;">shopping_cart</i>Add to cart</a> <a
						style="color: white;"
						href="<c:url value='/sendEmail/${product[status.index].productId}'/>"

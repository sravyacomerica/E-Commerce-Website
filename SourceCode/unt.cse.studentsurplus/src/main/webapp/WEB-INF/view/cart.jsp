...
<body>
	<form:form action="viewWishList" method="POST"
		...
		<center>
			<h2 style="color: black; margin-top: 10%;">
				<i id="home" class="material-icons"
					style="color: black; margin-right: 0%;">shopping_cart</i>Cart
			</h2>
		</center>
		<div class="progress">
		...
		<c:forEach items="${cartProductList}" var="element" varStatus="status">
				...
				<div class="row" id="product">
					...
					<div id="myproducts" class="col-lg-6 col-sm-6 col-md-6">
						...
						<a class="button" style="color: white;"
							href="<c:url value='/removeFromWishList/${cartProductList[status.index].productId}'/>"
							class="btn btn-danger" role="button"> <i
							class="material-icons" style="margin-right: -1%;">delete</i>Remove
							from cart
						</a> <a style="color: white;"
							href="<c:url value='/sendEmail/${cartProductList[status.index].productId}'/>"
							class="button"><i class="material-icons"
							style="margin-right: 0%;">mail</i>Send an email</a>
					</div>
				</div>
			</div>
		</c:forEach>

...
<body>
	<form action="home-after-search" method="POST">
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse" id="navbar"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a id="ncolor" href="/unt.cse.studentsurplus/login"><b>Login/Register</b></a></li>
				</ul>
			</div>
		</div>
		</nav>
			...
			<div class="container" align="center">
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						...
						<div class="item">
							<img src="resources/images/phone.jpg" style="width: 80%;">
						</div>

						<div class="item">
							<img src="resources/images/lamp.jpg" style="width: 80%;">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="input-group col-md-12">
					<spring:bind path="Search.searchString">
						<input name="${status.expression}" value="${status.value}"
							placeholder="Search" type="text" class="form-control input-lg"></input>
					</spring:bind>
